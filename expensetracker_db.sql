...
-- GRANT SELECT ON ALL SEQUENCES IN SCHEMA public TO expensetracker;
...
create sequence et_users_seq increment 1 start 2;
create sequence et_categories_seq increment 1 start 1;
create sequence et_transactions_seq increment 1 start 1000;

-- INSERT INTO ET_USERS(USER_ID, FIRST_NAME, LAST_NAME, EMAIL, PASSWORD) VALUES(NEXT_VAL('ET_USERS_SEQ'), 'John', 'Smith', 'john@test.com', 'test123');
ALTER SEQUENCE et_users_seq OWNER TO expensetracker;
ALTER SEQUENCE et_categories_seq OWNER TO expensetracker;
ALTER SEQUENCE et_transactions_seq OWNER TO expensetracker;